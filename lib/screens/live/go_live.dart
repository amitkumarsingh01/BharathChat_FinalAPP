...
class _GoLiveScreenState extends State<GoLiveScreen> {
  ...
  void _goLive(BuildContext context) async {
            ...
            child: Column(
              ...
              children: [
                ...
                TextField(
                  ...
                  style: const TextStyle(color: Colors.white),
                  decoration: const InputDecoration(
                    hintText: 'Enter your chatroom title',
                    hintStyle: TextStyle(color: Colors.grey),
                    enabledBorder: UnderlineInputBorder(
                      borderSide: BorderSide(color: Colors.grey),
                    ),
    ...
    if (result == true) {
      try {
        // Validate inputs
        if (nameController.text.isEmpty || chatroomController.text.isEmpty) {
          if (context.mounted) {
            ScaffoldMessenger.of(context).showSnackBar(
              const SnackBar(
        ...
        final liveUrl =
            'live_${timestamp}_${nameController.text.toLowerCase().replaceAll(' ', '_')}';
        ...
        if (isVideoMode) {
          ...
          data = {
            'title': chatroomController.text,
            'chat_room': nameController.text,
            'hashtag': [selectedHashtag],
            'music_id': musicId,
        ...
        final streamTitle =
            isVideoMode ? selectedCategory : chatroomController.text;
