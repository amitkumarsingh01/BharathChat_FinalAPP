...
class _CreatorInvitationScreenState extends State<CreatorInvitationScreen> {
  ...
  Future<void> _submitInvitation() async {
    ...
    final body = {
      "user_id": 2, // TODO: Replace with actual user_id
      "name": _nameController.text,
      "moj_handle": _handleController.text,
      "gender": _gender,
      "date_of_birth": {
    ...
    try {
      ...
      if (response.statusCode == 200) {
        ScaffoldMessenger.of(
          context,
        ).showSnackBar(SnackBar(content: Text('Invitation accepted!')));
          ...
          child: Column(
            ...
            children: [
              ...
              TextField(
                ...
                style: TextStyle(color: Colors.white),
                decoration: _inputDecoration('Bharath Chat Handle'),
              ),
              SizedBox(height: 16),
              ...
              Row(
                children: [
                  ...
                  Expanded(
                    child: Text(
                      'I accept Bharath Chat Terms of Use',
                      style: TextStyle(color: Colors.white),
                    ),
                  ),
                ],
