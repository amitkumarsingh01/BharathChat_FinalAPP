...
import '../profile/BlockedUser.dart';
...
class _ChatScreenState extends State<ChatScreen>
  ...
  List<dynamic> get _filteredUsers {
    ...
    final users =
        _allUsers.where((user) => user['id'] != currentUserId).toList();
      ...
      return Container(
        ...
        child: ListTile(
          leading: CircleAvatar(
            ...
            child:
                (user['user']['profile_pic'] != null &&
                        user['user']['profile_pic'].isNotEmpty)
                                  ...
                                  onPressed: () async {
                                    ...
                                    try {
                                      ...
                                      ScaffoldMessenger.of(
                                        ...
                                        const SnackBar(
                                          content: Text(
                                            'Failed to send "Say Hii!" message.',
                                          ),
                                        ),
                                      );
                                    } finally {
                                      setState(() {
                                        user['isSendingHi'] = false;
                                      });
                                    }
                                  },
                                  child:
