...
class _FollowingScreenState extends State<FollowingScreen> {
  ...
  Set<int> _followingSet = {};
  Set<int> _blocked = {};

  @override
  void initState() {
    super.initState();
    _loadFollowingAndRelations();
  }

  Future<void> _loadFollowingAndRelations() async {
    setState(() {
      _isLoading = true;
    });
    try {
      ...
      setState(() {
        ...
        _followingSet = Set<int>.from(relations['following'] ?? []);
      ...
      ScaffoldMessenger.of(context).showSnackBar(
        SnackBar(
          content: Text('Failed to load following: ${e.toString()}'),
  ...
  void _followUser(int userId) async {
    try {
      if (_followingSet.contains(userId)) {
      ...
      await _loadFollowingAndRelations();
    } catch (e) {
          ...
          _isLoading
              ...
              : ListView.separated(
                ...
                itemBuilder: (context, index) {
                  ...
                  final isFollowing = _followingSet.contains(user['id']);
