...
class _RegistrationScreenState extends State<RegistrationScreen> {
  ...
  String? _uploadedProfilePicPath;
                      ...
                      CircleAvatar(
                        ...
                        backgroundImage:
                            _profileImage != null
                                ...
                                : (_uploadedProfilePicPath != null
                                    ? NetworkImage(_uploadedProfilePicPath!.startsWith('http') ? _uploadedProfilePicPath! : 'https://server.bharathchat.com/' + _uploadedProfilePicPath!)
                                    : null),
                        child:
                            _profileImage == null && _uploadedProfilePicPath == null
                                ? const Icon(
                                  Icons.person,
                                  size: 60,
                                  color: Colors.grey,
