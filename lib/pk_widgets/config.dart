  ...
  return ZegoLiveStreamingPKBattleConfig(
    ...
    foregroundBuilder: (
      ...
      return Container(
        ...
        child: const Center(child: Text('pkBattleViewForegroundBuilder')),
      );
    },
    topBuilder: (
      BuildContext context,
      ...
      return Container(
        ...
        child: const Center(child: Text('pkBattleViewTopBuilder')),
      );
    },
    bottomBuilder: (
      BuildContext context,
      ...
      return Container(
        decoration: BoxDecoration(border: Border.all(color: Colors.yellow)),
        child: const Center(child: Text('pkBattleViewBottomBuilder')),
      );
    },
  );
}
...
class PKGridLayout extends ZegoLiveStreamingPKMixerLayout {
  ...
  @override
  List<Rect> getRectList(int hostCount, {double scale = 1.0}) {
